...
You can use the typical ways to render the files, through the RStudio `knit` button, or using `rmarkdown::render("yourpaper/yourarticle.Rmd")` on the R command line. 
