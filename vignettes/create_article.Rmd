...
This will generate 
  ...
  - quokka-bilby.bib, 
  - quokka-bilby.Rmd, and 
  - RJwrapper.tex
  
in a folder called "paper". One last step before start on writing is to make a change on the bibliography reference in the Rmd YAML. By default, the template generates `bibliography: RJreferences.bib` in the YAML and you need to replace `RJreferences` with the file name you just specified: `quokka-bilby`.
