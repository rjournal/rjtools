...
- Title are in title case
- Section titles are in sentence case
- No special formatting is used in the title
...
- Mathematical operators (eg log) should be roman, not italic

## Code

- Needs to be embedded in backticks
- Styled and indented nicely
...
- All R packages used in the work are appropriately cited, eg `ggplot` if this is used to create the figures
