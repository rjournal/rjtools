...
Figure `r knitr::asis_output(ifelse(knitr::is_html_output(), '\\ref{fig:penguins-plotly}', '\\ref{fig:penguins-ggplot}'))` shows an `r ifelse(knitr::is_html_output(), 'interactive', '')` plot of the \CRANpkg{palmerpenguins} data [@palmerpenguins], made using the `r knitr::asis_output(ifelse(knitr::is_html_output(), '\\CRANpkg{plotly}', '\\CRANpkg{ggplot2}'))` package. 
