...
Figure \ref{fig:penguins-ggplot} shows a plot of the penguins data, made using the \CRANpkg{ggplot2} package.
...
\begin{figure}
\includegraphics[width=1\linewidth]{paper-with-errors_files/figure-latex/penguins-ggplot-1} \caption{A basic non-interactive plot made with the ggplot2 package on palmer penguin data. Three species of penguins are plotted with bill depth on the x-axis and bill length on the y-axis. Visit the online article to access the interactive version made with the plotly package.}\label{fig:penguins-ggplot}
\end{figure}
